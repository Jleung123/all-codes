...
<html>
	...
	<body data-spy = "scroll" data-target = ".site-navbar-target" data-offset = "300">
		<div class = "site-wrap">
						...
						<div class = "col-md-12" data-aos = "fade-up" data-aos-delay = "400">    
							<div class = "row justify-content-center mb-4">
								<div class = "col-md-8 text-center">
									<h1>Login and see our <span class = "typed-words"></span></h1>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- end of intro artwork for login -->	
			<!-- display menu for login page -->
				...
				<div class = "container">
					<form>
						<table align = "center">
							...
							<tr>
								<td width = "150"><button href = "registration..php"
									data-fancybox data-ratio = "2" class = "btn btn-primary btn-md">Register</button></td>
								<td><button value = "Login" data-fancybox data-ratio = "2" class = "btn btn-primary btn-md">Login</button></td>
							</tr>
						</table>
					</form>
				</div>
